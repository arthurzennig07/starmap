"""
This script crops a source image based on azimuth (as degrees) and coordinates as hours.
"""
from skyfield import api, almanac
from PIL import ImageDraw, Image, ImageFilter
from Shared.Constants import Angle
...
def get_ra_dec_above_observer(year, month, day, hour, min, lat, lon):
    ...
    pos = observer.from_altaz(alt_degrees=Angle.ZENITH, az_degrees=Angle.HORIZON)
...
def convert_radec_to_centesimal(ra, dec, image_width, image_height):
    y = round(((image_height / 2) * dec) / Angle.ZENITH, 0)  # 90 graus
    if (y < 0):
...
def main():
    ...
    ra, dec = get_ra_dec_above_observer(2023, 2, 1, 22, 10, -41.00106, -20.37511)
